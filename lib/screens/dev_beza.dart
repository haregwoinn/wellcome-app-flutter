...
class ProfileBeza extends StatelessWidget {
  const ProfileBeza({Key? key}) : super(key: key);
      ...
      body: Column(
        children: <Widget>[
            ...
            children: <Widget>[
              ...
              const Positioned(
                ...
                child: CircleAvatar(
                  ...
                  backgroundImage: AssetImage('assets/svg/g.jpg'),
                ),
              ),
            ],
          ),
          ...
          const ListTile(
            ...
            subtitle: Text(
                'Hi, I\'m Beza Kebede from ethiopia.\nI\'m an Android Developer for Company in ethiopia. Over 3 years of Experienced Software Development.\nI have serious passion for UI/UX, and sometimes fullstack. Feel free to check my portfolio on BezaKebede.com',
